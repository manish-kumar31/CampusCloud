...
const Teachers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['name', 'department', 'emailId', 'dob', 'contactNo', 'address', 'gender'];
    ...
    try {
      const response = await axios.post('http://localhost:8080/api/uploadFaculty', payload, {
        headers: {
